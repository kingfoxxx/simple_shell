...
/**
 * cd_dot - cd int the parent directory path
 *
...
/**
 * cd_to - changes to a directory available
 * by the user
 *
...
/**
 * cd_previous - changes to the previous directory from the available source
 *
 * @datash: data relevant (environ)
 * Return: no return
 */
...
/**
 * cd_to_home - move to home directory
 *
 * @datash: data relevant (environ)
 * Return: no return
 */
